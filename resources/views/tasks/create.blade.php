@extends('app')
@section('title')Создать задачу@endsection
@section('content')
    <div class="container w-50">
        <h1 class="text-center mt-5 mb-5">Создать задачу</h1>
        @if ($errors->any())
        ...
        @endif
        <form class="row g-3" method="post" action="{{ route('tasks.store') }}">
            @csrf
            ...
            <div class="mb-3 col-md-12">
                <div class="form-text mt-2">0 - неактивный, 1 - активный (по умолчанию)</div>
            </div>
